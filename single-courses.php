            ...
            <div class="container">
                ...
                <div class="course-single-item">
                    ...
                    <ul class="course-meta">
                        <li><i class="fa fa-user" aria-hidden="true"></i>Robot Smith</li>
                        <li><i class="fa fa-calendar" aria-hidden="true"></i>24 April 2017</li>
                        <li><i class="fa fa-comments" aria-hidden="true"></i>350 Comments</li>
                        <li class="rating">
    ...
    <?php } else { ?>
        <section class="courses padding-120">
            <div class="container no-access">
                <h4>You do not have access to this course</h4>
                <a href="<?php the_field('enrolment_url'); ?>"><button>Subscribe</button></a>
            </div>
        </section>
    <?php } ?>
</main><!-- #main -->
